...
type RestOf<T extends ICandidature | NewCandidature> = Omit<T, 'dateCandidature'> & {
...
export class CandidatureService {
  ...
  protected convertDateFromClient<T extends ICandidature | NewCandidature | PartialUpdateCandidature>(candidature: T): RestOf<T> {
    return {
      ...candidature,
      dateCandidature: candidature.dateCandidature?.format(DATE_FORMAT) ?? null,
    };
  }
  ...
  protected convertDateFromServer(restCandidature: RestCandidature): ICandidature {
    return {
      ...restCandidature,
      dateCandidature: restCandidature.dateCandidature ? dayjs(restCandidature.dateCandidature) : undefined,
    };
  }
