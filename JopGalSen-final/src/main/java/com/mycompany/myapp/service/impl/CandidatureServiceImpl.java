...
public class CandidatureServiceImpl implements CandidatureService {
    ...
    public Page<CandidatureDTO> findAllWithEagerRelationships(Pageable pageable) {
        return candidatureRepository.findAllWithEagerRelationships(pageable).map(candidatureMapper::toDto);
    }
    ...
    public Optional<CandidatureDTO> findOne(Long id) {
        ...
        return candidatureRepository.findOneWithEagerRelationships(id).map(candidatureMapper::toDto);
    }
