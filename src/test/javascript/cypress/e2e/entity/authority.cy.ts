...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '3ce35efa-96d0-4d83-8a22-b527357d3772' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('35a75880-3bdb-4f41-a944-94248700da9c');
      cy.get(`[data-cy="name"]`).should('have.value', '35a75880-3bdb-4f41-a944-94248700da9c');
