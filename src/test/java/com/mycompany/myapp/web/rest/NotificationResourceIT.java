...
class NotificationResourceIT {
    ...
    private static final TypeNotification DEFAULT_TYPE_NOTIF = TypeNotification.INFO;
    private static final TypeNotification UPDATED_TYPE_NOTIF = TypeNotification.ALERT;
    ...
    public static Notification createEntity() {
        return new Notification().message(DEFAULT_MESSAGE).typeNotif(DEFAULT_TYPE_NOTIF);
    }
    ...
    public static Notification createUpdatedEntity() {
        return new Notification().message(UPDATED_MESSAGE).typeNotif(UPDATED_TYPE_NOTIF);
    }
    ...
    void getAllNotifications() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.[*].typeNotif").value(hasItem(DEFAULT_TYPE_NOTIF.toString())));
    }
    ...
    void getNotification() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.typeNotif").value(DEFAULT_TYPE_NOTIF.toString()));
    }
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.message(UPDATED_MESSAGE).typeNotif(UPDATED_TYPE_NOTIF);
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.message(UPDATED_MESSAGE).typeNotif(UPDATED_TYPE_NOTIF);
