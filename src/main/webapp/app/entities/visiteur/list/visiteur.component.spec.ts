...
import { sampleWithRequiredData } from '../visiteur.test-samples';
import { VisiteurService } from '../service/visiteur.service';

import { VisiteurComponent } from './visiteur.component';
import SpyInstance = jest.SpyInstance;

describe('Visiteur Management Component', () => {
  let comp: VisiteurComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(VisiteurComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.visiteurs()[0]).toEqual(expect.objectContaining({ id: 21785 }));
  });

  describe('trackId', () => {
    it('should forward to visiteurService', () => {
      const entity = { id: 21785 };
      jest.spyOn(service, 'getVisiteurIdentifier');
      const id = comp.trackId(entity);
      expect(service.getVisiteurIdentifier).toHaveBeenCalledWith(entity);
