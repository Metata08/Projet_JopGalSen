...
public class OffreResource {
    ...
    public ResponseEntity<Offre> partialUpdateOffre(
        ...
        Optional<Offre> result = offreRepository
            ...
            .map(existingOffre -> {
                if (offre.getTitle() != null) {
                    existingOffre.setTitle(offre.getTitle());
                }
                if (offre.getCompany() != null) {
                    existingOffre.setCompany(offre.getCompany());
                }
                ...
                if (offre.getSalary() != null) {
                    existingOffre.setSalary(offre.getSalary());
                }
                ...
                if (offre.getPostedDate() != null) {
                    existingOffre.setPostedDate(offre.getPostedDate());
                }
    ...
    public ResponseEntity<List<Offre>> getAllOffres(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        ...
        Page<Offre> page = offreRepository.findAll(pageable);
