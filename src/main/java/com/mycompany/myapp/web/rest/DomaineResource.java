...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Domaine}.
 */
@RestController
...
public class DomaineResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Domaine>> getAllDomaines(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
